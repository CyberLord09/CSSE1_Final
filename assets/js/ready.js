  ...
  function startGame() {
    console.log("started game anim")
    document.querySelectorAll('.container button').forEach(function(button) {
      button.style.display = 'none';
    });
    gameStarted = true;
    console.log("changed gamestarted to " + gameStarted)
  ...
  function keyDownHandler(e){
    if (e.keyCode == 81)
      {
          qPressed = true;
          document.getElementById("p1tank").src="/student/images/sprite/tank2.png";
      }
    if (e.keyCode == 191)
      {
          slashPressed = true;
          document.getElementById("p2tank").src="/student/images/sprite/tank2.png";
      }
  }
  

  document.addEventListener("keydown", (event) => {
    if (qPressed && slashPressed) {
      qPressed = false;
      slashPressed = false;
      setTimeout(closeInstructions, 500);
